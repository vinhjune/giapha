...
def generate_image(
    ...
    """Generate image through the pinned multix backend."""
    ...
    if resolved_provider == "auto":
        ...
        if env_provider in {"google", "openrouter"}:
            ...
            resolved_provider = "openrouter" if (
                os.getenv("OPENROUTER_API_KEY") and not os.getenv("GEMINI_API_KEY")
            ) else "google"
    ...
    try:
        ...
        return {"status": "success", "output": output_path, "model": model_id}
